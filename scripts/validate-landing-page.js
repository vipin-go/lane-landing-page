...
const ALLOWED_DESIGN_VARIANTS = new Set(['default', 'signature', 'banking', 'form-operations', 'cinematic-campaigns', 'recruiting-operations', 'grocery-twin', 'event-introductions']);
